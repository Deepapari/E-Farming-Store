 ...
 %>
	...
	<div class="contact">
		<div class="container">
			...
			<p>
			<h4>If you want any help regarding products.</h4>
			</p>
			<br>
			<div>
				<h4 class="section-subheading" align="left">
					<i class='fas fa-user'>&nbsp;&nbsp;Deepa Pari</i>
				</h4>
			</div>
			<div>
				<h4 class="section-subheading" align="left">
					<i class='fas fa-envelope'>&nbsp;&nbsp;deepa@gmail.com.</i>
				</h4>
			</div>
			<div>
				<h4 class="section-subheading" align="left">
					<i class='fas fa-phone'>&nbsp;&nbsp;8190991234.</i>
				</h4>
			</div>
			<div>
