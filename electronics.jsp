...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<meta name="keywords"
	content="E-Farming Store Responsive web template, Bootstrap Web Templates, Flat Web Templates, Android Compatible web template, 
	...
	<div class="header-bot">
		<div class="container">
			<div class="col-md-3 header-left">
				<h1>
					<a href="index-2.html"><img src="images/logo3.png"></a>
				</h1>
			</div>
			...
			<div class="ele-bottom-grid">
				...
				<%
					ResultSet retriveProduct = DatabaseConnection
						.getResultFromSqlQuery("select * from tblproduct where product_category='Millets'");
